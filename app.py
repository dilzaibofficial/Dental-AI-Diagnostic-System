...
# Page configuration
st.set_page_config(page_title="Dental AI Report System", layout="wide")
...
def generate_pdf(original_img, result_img, findings, suggestions):
    ...
    # Saving images locally for PDF placement
    ...
    pdf.image("temp_res.jpg", x=105, y=pdf.get_y()-52, w=90) # Position adjusted
    pdf.ln(60)
